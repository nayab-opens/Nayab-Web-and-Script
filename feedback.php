<?php /*
	...
	Generated by thesitewizard.com's Feedback Form Wizard 3.2.1.
...
$mailto = 'nayab.khan@ontariotechu.net' ;
...
$headers =
	"From: \"$fullname\" <$fromemail>" . $linesep . "Reply-To: \"$fullname\" <$email>" . $linesep . "X-Mailer: chfeedback.php 3.2.1" .
